...
test(`renders ${LABEL.work} label`, async () => {
  render(<Label isWorking={true} isLongBreak={false} labelColor={0xffffff} />);
...
test(`renders ${LABEL.shortBreak} label`, async () => {
  render(<Label isWorking={false} isLongBreak={false} labelColor={0xffffff} />);
...
test(`renders ${LABEL.longBreak} label`, async () => {
  render(<Label isWorking={false} isLongBreak={true} labelColor={0xffffff} />);
